            ...
            <div class="container px-6 py-3 mx-auto">
               ...
               <div class="flex items-center flex-shrink-0 text-white mr-6">
                  ...
                  <div class="flex flex-col sm:flex-row">
                     <a class="mt-3 hover:underline sm:mx-3 sm:mt-0" href="{{ route('newproduct.list')}}">Home</a>
                     <a class="mt-3 hover:underline sm:mx-3 sm:mt-0" href="{{ route('newproduct.list')}}">Shop</a>
